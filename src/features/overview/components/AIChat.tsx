    ...
    <div className="rounded-lg border border-white/5 bg-white/[0.02] overflow-hidden flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-3">
        {messages.map((msg) => (
          <div
            key={msg.id}
            className={`flex gap-2 ${msg.senderRole === 'DEV' ? 'flex-row-reverse' : ''}`}
          >
            <div
            ...
            >
              {msg.senderRole === 'DEV' ? 'Y' : <Bot size={10} />}
            </div>
            <div
        ...
        {isTyping && (
          <div className="flex gap-2">
            ...
            <div className="bg-white/5 rounded-md px-3 py-2 flex items-center gap-1">
      ...
      <div className="p-3 border-t border-white/5">
        <div className="flex gap-2">
          <input
            ...
            placeholder="Ask..."
            className="flex-1 bg-black/50 border border-white/10 rounded-md text-xs text-slate-200 px-3 py-2 outline-none focus:border-emerald-500/50"
          />
          <button
